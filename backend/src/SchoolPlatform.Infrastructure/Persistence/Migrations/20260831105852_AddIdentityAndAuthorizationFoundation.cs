...
{
    /// <inheritdoc />
    public partial class AddIdentityAndAuthorizationFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_membership_roles_roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_membership_roles_tenant_memberships_MembershipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_membership_roles_MembershipId",
                table: "membership_roles",
                column: "MembershipId");

            migrationBuilder.CreateIndex(
                name: "IX_membership_roles_RoleId",
                table: "membership_roles",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_membership_roles_TenantId_MembershipId_RoleId",
                table: "membership_roles",
                columns: new[] { "TenantId", "MembershipId", "RoleId" },
                unique: true);
